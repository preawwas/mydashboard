    ...
    return (
        <DashboardLayout>
            <div className="space-y-4 md:space-y-6 max-w-[1400px] mx-auto pb-10">
                {/* Header & Tabs */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-gray-100 pb-3 md:pb-4 mb-4 md:mb-6 pt-2">
                    <div className="flex flex-col gap-1">
                        <p className="text-[10px] font-extrabold tracking-widest text-[#a1a1aa] uppercase drop-shadow-sm">Curated Portfolio</p>
                        <h1 className="text-xl md:text-[28px] font-extrabold text-[#0D3B38] tracking-tight leading-none">Investment Portfolio</h1>
                    </div>
                    
                    <div className="flex items-center gap-4 md:gap-6 mt-2 sm:mt-0">
                        <nav className="flex gap-4 md:gap-6 relative top-[9px]">
                            <button
                        ...
                        <Button 
                            ...
                            className="bg-[#2b7a71] text-white hover:bg-[#1f5c54] rounded-lg px-4 md:px-5 py-2.5 font-bold text-[13px] ml-2 shadow-sm border-none"
                        >
                            <span className="hidden sm:inline">Add Investment</span><span className="sm:hidden">Add</span>
                        </Button>
                    </div>
                </div>
                ...
                {isLoading && investments.length === 0 ? null : activeTab === 'overview' ? (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-[#f8f8f9] rounded-[20px] md:rounded-[32px] p-3 md:p-4 sm:p-6 mb-4 md:mb-8 flex flex-col gap-4 md:gap-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                                <div className="flex-1">
                                    <Input
                                        ...
                                        className="h-[44px] md:h-[52px] rounded-full border-transparent hover:border-transparent focus:border-transparent focus:ring-2 focus:ring-[#0D3B38]/20 shadow-sm pl-[44px] pr-10 bg-white text-sm sm:text-base text-[#18181b]"
                                    />
                                </div>
                                <div className="flex gap-2 md:gap-3">
                                    <Button
                                        ...
                                        className={`h-[44px] md:h-[52px] rounded-full px-4 md:px-6 sm:px-8 text-sm sm:text-base font-medium transition-colors border-0 align-middle ${
                                            showFilters 
                            ...
                            <div className={`grid grid-cols-1 sm:grid-cols-3 gap-4 transition-all duration-300 origin-top ${showFilters ? 'opacity-100 scale-y-100 h-auto' : 'opacity-0 scale-y-0 h-0 overflow-hidden hidden'}`}>
                                <div>
                                    ...
                                    <Select
                                        ...
                                        className="h-[44px] md:h-[52px] rounded-full border-transparent hover:border-transparent focus:border-transparent focus:ring-2 focus:ring-[#0D3B38]/20 shadow-sm px-4 md:px-6 bg-white text-[#18181b] font-medium"
                                    />
                                </div>
                                <div>
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <div className="flex flex-col md:flex-row justify-end gap-3 pt-4">
                                    <Button variant="secondary" onClick={() => setDeleteConfirm(null)} disabled={deleting} className="w-full md:w-auto">
                                        Cancel
                                    </Button>
                                    <Button variant="danger" onClick={handleDeleteInvestment} isLoading={deleting} className="w-full md:w-auto">
                                        Delete
                                    </Button>
                                </div>
                            </div>
